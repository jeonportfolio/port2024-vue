                    ...
                    <p>{{ text.desc }}</p>
                        ...
                        <div>
                            ...
                            <p > ▶한국공학대학교(IT경영학과)(2019.03 ~ 2025.02(졸업예정))<br/><br/>
                                 ▶웹디자인기능사 취득<br/><br/>
                                 ▶머니스테이션(인턴과정(실습 및 파트) 2024.01.02 ~ 2024.12.01)(마케팅부서) <br/><br/>
                                 ▶OPIC IH등급<br/><br/>
                                 ▶SQLD 취득<br/><br/>
                                 ▶컴퓨터활용능력 2급 취득<br/><br/>
                        ...
                        <div>
                            ...
                            <p > <h4 >★ HTML/CSS/JAVA SCRIPT/GSAP</h4><br/>
                                  ...
                                  <br/><br/>
                                  <h4 >★REACT.JS</h4><br/>
                                  → 포트폴리오 사이트 (GSAP & (vue.js,next.js로 변환))<br/><br/>
                                  ...
                                  <a className="go" href="https://github.com/jeonportfolio/CHATTING-APP-client-" target="blank">프론트 코드보기</a>   <a className="go" href="https://github.com/jeonportfolio/CHATTING-APP-client-" target="blank">백엔드 코드보기</a><br/><br/><br/>
